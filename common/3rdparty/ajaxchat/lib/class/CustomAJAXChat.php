...
class CustomAJAXChat extends AJAXChat {
    ...
    function getValidLoginUserData() {
        ...
        return $this->getXMLNukeUserData($_REQUEST['login']);
...
//		}
    ...
    function getXMLNukeUserData($login) {
        $sql = "SELECT	id_usuario, nome_completo_usuario
		FROM    usuario
		WHERE 	login_usuario = '" . trim($login) . "'";
        ...
        $userData = array();
        $userData['userID'] = $row['id_usuario'];
        $userData['userName'] = $row['nome_completo_usuario']; //$this->trimUserName($_REQUEST['login']);
