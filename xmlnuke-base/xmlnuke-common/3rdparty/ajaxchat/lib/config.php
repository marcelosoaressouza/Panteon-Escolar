...
//'ar','bg','bp','ca','cy','cz','de','el','en','es','et','fi','fr','gl','he','hr','hu','in','it','ka','kr','ja','nl','no','pl','ro','ru','sk','sl','sr','sv','tr','uk','zh','zh-tw');
// Default language:
...
// Available styles:
$config['styleAvailable'] = array('beige');
// ,'black','grey','Oxygen','Lithium','Sulfur','Cobalt','Mercury','Radium','prosilver','subsilver2','subblack2','subSilver','Core','MyBB','vBulletin');
// Default style:
...
//$config['defaultChannelName'] = 'Geral';
...
$config['chatBotName'] = 'PanteonChat';
