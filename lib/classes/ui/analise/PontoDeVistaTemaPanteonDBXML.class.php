  ...
  public function generateObject($current) {
    ...
    if($this->_opcao == "processPageField") {
      ...
      if($this->_context->ContextValue("acao") == "verPontoDeVista") {
        ...
        if($idSujeito != "") $this->_context->addCookie("id_sujeito_definido", $idSujeito);
        if($this->_context->getCookie("id_sujeito_definido") != "") $idSujeito = $this->_context->getCookie("id_sujeito_definido");
