...
class TemaPanteonDBXML extends XmlnukeCollection implements IXmlnukeDocumentObject
{
  ...
  public function criarProcessPageFields($permissao = "",
    ...
    if(($this->_context->ContextValue("acao") == "") || ($this->_context->ContextValue("acao") == "move")) $field->editListFormatter = new PanteonEscolarMetodoAnaliseFormatter($this->_context, "view");
    $fieldList->addProcessPageField($field);
    ...
    if(($this->_context->ContextValue("acao") == "") || ($this->_context->ContextValue("acao") == "move")) $field->editListFormatter = new PanteonEscolarEstruturaSocialFormatter($this->_context, "view");
    $fieldList->addProcessPageField($field);
    ...
    if($get_tema_panteon == true) {
      ...
      $field->editable = false;
      if(($this->_context->ContextValue("acao") == "") || ($this->_context->ContextValue("acao") == "move")) $field->editListFormatter = new PanteonEscolarTemaPanteonFormatter($this->_context, "coletarBiblioteca");
    ...
    if($admin == false) {
      if($publicado == "true") {
        ...
        if($id_criador          != "") $filtro .= " AND id_usuario = "          . $id_criador          ." ";
      }

      if($id_criador != "") $filtro .= " id_usuario = " . $id_criador ." ";
      ...
      if($id_instituicao != "") {
        ...
        while($itUsuario->hasNext()) {
          ...
          if($itUsuario->hasNext()) $filtro .= " OR ";
