...
class UsuarioXMensagemForumDB extends PanteonEscolarBaseDBAccess
{
    protected $_nome_tabela = "usuario_x_mensagem_forum";
    protected $_nome_tabela_primaria = "usuario";
    protected $_nome_tabela_secundaria = "mensagem_forum";
    ...
    */
    public function obterPorId($id)
    {
        ...
        $model = new UsuarioXMensagemForumModel();
     ...
     * @return IIterator
    */
    public function obterTodosOsUsuariosPorIDMensagemForum($id)
    {
        $sql = "SELECT * FROM ";
        $sql .= $this->_nome_tabela;
