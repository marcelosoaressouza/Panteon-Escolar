...
class SituacaoProblemaDB extends PanteonEscolarBaseDBAccess
{
  protected $_nome_tabela = "situacao_problema";
   ...
   * @return IIterator
   */
  public function obterTodasAsSituacoesProblemasPorIDTemaPanteon($id) {
    $sql = "SELECT * FROM ";
    $sql .= $this->_nome_tabela;
  ...
  */
  public function obterPorId($id) {
    ...
    $model = new SituacaoProblemaModel();
