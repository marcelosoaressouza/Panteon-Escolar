...
class NotaDB extends PanteonEscolarBaseDBAccess
{
    protected $_nome_tabela = "nota";
     ...
     * @return IIterator
     */
    public function obterTodasAsNotasPorIDUsuario($id)
    {
        $sql = "SELECT * FROM ";
        $sql .= $this->_nome_tabela;
     ...
     * @return IIterator
     */
    public function obterTodasAsNotasPorIDTemaPanteon($id)
    {
        $sql = "SELECT * FROM ";
        $sql .= $this->_nome_tabela;
