...
class MidiatecaDB extends PanteonEscolarBaseDBAccess
{
  protected $_nome_tabela = "midiateca";
  protected $_nome_tabela_primaria = "tipo_midia";
   ...
   * @return IIterator
   */
  public function obterTodasAsMidiatecasPorIDTipoMidia($id)
  {
    $sql = "SELECT * FROM ";
    $sql .= $this->_nome_tabela;
   ...
   * @return IIterator
   */
  public function obterTodasAsMidiatecasPorNomeTag($nome_tag)
  {
    $sql = "SELECT * FROM ";
    $sql .= $this->_nome_tabela;

    $sql .= " WHERE tag_midiateca LIKE '%".$nome_tag."%'";
