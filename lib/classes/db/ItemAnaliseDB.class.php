...
class ItemAnaliseDB extends PanteonEscolarBaseDBAccess
{
  protected $_nome_tabela = "item_analise";
   ...
   * @return IIterator
   */
  public function obterTodosOsItensAnalisePorIDMetodoAnalise($id) {
    $sql = "SELECT * FROM ";
    $sql .= $this->_nome_tabela;
