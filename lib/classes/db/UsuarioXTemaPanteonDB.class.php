...
class UsuarioXTemaPanteonDB extends PanteonEscolarBaseDBAccess
{
  ...
  protected $_nome_tabela_quartenaria = "usuario_x_grupo";
  ...
  * @return IIterator
  */
  public function obterTodosOsUsuariosQueNaoEstaoNoGrupoPorIDTemaPanteonEPorIDGrupo($id_tema_panteon, $id_grupo)
  {
    $sql = "SELECT * FROM ";
    $sql .= $this->_nome_tabela;
    ...
    $sql .= " INNER JOIN ".$this->_nome_tabela_quartenaria;
    $sql .= " ON ".$this->_nome_tabela.".id_".$this->_nome_tabela_primaria;
    $sql .= " = ".$this->_nome_tabela_quartenaria.".id_".$this->_nome_tabela_primaria;


    // Mudar Esta Parte para Consultar na Tabela Primaria ou Secundaria
    $sql .= " WHERE ".$this->_nome_tabela.".id_".$this->_nome_tabela_secundaria." = ".$id_tema_panteon;
    $sql .= " AND ".$this->_nome_tabela_quartenaria.".id_".$this->_nome_tabela_primaria;
    $sql .= " NOT IN ( ";

    $sql .= "SELECT ".$this->_nome_tabela.".id_".$this->_nome_tabela_primaria." FROM ";
    $sql .= $this->_nome_tabela;
    ...
    // Mudar Esta Parte para Consultar na Tabela Primaria ou Secundaria
    $sql .= " WHERE ".$this->_nome_tabela.".id_".$this->_nome_tabela_secundaria." = ".$id_tema_panteon;
    $sql .= " AND ".$this->_nome_tabela_quartenaria.".id_grupo = ".$id_grupo;

    $sql .= " ) ";
    $sql .= " ORDER BY nome_completo_usuario ASC";
  ...
  * @return IIterator
  */
  public function obterTodosOsUsuariosQueEstaoNoGrupoPorIDTemaPanteonEPorIDGrupo($id_tema_panteon, $id_grupo)
  {
    $sql = "SELECT * FROM ";
    $sql .= $this->_nome_tabela;
