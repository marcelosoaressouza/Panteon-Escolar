...
class MetodoAnaliseDB extends PanteonEscolarBaseDBAccess
{
    protected $_nome_tabela = "metodo_analise";
     ...
     * @return IIterator
     */
    public function obterTodosOsMetodosAnalisePorIDUsuario($id)
    {
        $sql = "SELECT * FROM ";
        $sql .= $this->_nome_tabela;
