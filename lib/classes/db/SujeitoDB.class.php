...
class SujeitoDB extends PanteonEscolarBaseDBAccess
{
  protected $_nome_tabela = "sujeito";
  protected $_nome_tabela_primaria = "tema_panteon";
  protected $_nome_tabela_secundaria = "grupo_social";
   ...
   * @return IIterator
   */
  public function obterTodosOsSujeitosPorIDTemaPanteon($id) {
    $sql = "SELECT * FROM ";
    $sql .= $this->_nome_tabela;
   ...
   * @return IIterator
   */
  public function obterTodosOsSujeitosPorIDGrupoSocial($id) {
    $sql = "SELECT * FROM ";
    $sql .= $this->_nome_tabela;
