...
class MeuForumMensagensTopico extends PanteonEscolarBaseModule
{
  ...
  public function CreatePage()
  {
    ...
    $blockHead->addXmlnukeObject(new MeuForumMensagensTopicoDBXML($this->_context, "menuHead"));

    $this->defaultXmlnukeDocument->addXmlnukeObject($blockInfo);
    $blockInfo->addXmlnukeObject(new MeuForumMensagensTopicoDBXML($this->_context, "listarDireita"));

    $this->defaultXmlnukeDocument->addXmlnukeObject($blockMenu);
    $blockMenu->addXmlnukeObject(new MeuForumMensagensTopicoDBXML($this->_context, "menu"));

    $this->defaultXmlnukeDocument->addXmlnukeObject($blockCenter);
    $blockCenter->addXmlnukeObject(new MeuForumMensagensTopicoDBXML($this->_context, "processPageField"));
