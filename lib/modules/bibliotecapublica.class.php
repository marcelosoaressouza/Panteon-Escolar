...
class BibliotecaPublica extends PanteonEscolarBaseModule
{
  ...
  public function CreatePage()
  {
    ...
    $this->defaultXmlnukeDocument = new XmlnukeDocument("Biblioteca Tema Panteon", "Biblioteca Tema Panteon");
