...
class VerUsuarioXPontoDeVista extends PanteonEscolarBaseModule
{

  public function CreatePage() {
    $myWords = $this->WordCollection();

    $titulo = "Ver Usuário x Ponto de Vista";
    ...
    $blockCenter->addXmlnukeObject(new VerUsuarioXPontoDeVistaDBXML($this->_context, "ver"));
