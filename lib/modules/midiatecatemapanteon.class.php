...
class MidiatecaTemaPanteon extends PanteonEscolarBaseModule
{
    ...
    public function CreatePage()
    {
        ...
        $titulo = "Midiateca do Tema Panteon";
        ...
        $blockHead->addXmlnukeObject(new MidiatecaTemaPanteonDBXML($this->_context, "menuHead"));

        $this->defaultXmlnukeDocument->addXmlnukeObject($blockInfo);
        $blockInfo->addXmlnukeObject(new MidiatecaTemaPanteonDBXML($this->_context, "listarDireita"));

        $this->defaultXmlnukeDocument->addXmlnukeObject($blockMenu);
        $blockMenu->addXmlnukeObject(new MidiatecaTemaPanteonDBXML($this->_context, "menu"));

        $this->defaultXmlnukeDocument->addXmlnukeObject($blockCenter);
        $blockCenter->addXmlnukeObject(new MidiatecaTemaPanteonDBXML($this->_context, "processPageField"));
