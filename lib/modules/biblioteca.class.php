...
class Biblioteca extends PanteonEscolarBaseModule
{
  ...
  public function CreatePage()
  {
    ...
    $titulo = "Biblioteca Tema Panteon";
    ...
    $blockHead->addXmlnukeObject(new BibliotecaDBXML($this->_context, "menuHead"));

    $this->defaultXmlnukeDocument->addXmlnukeObject($blockInfo);
    $blockInfo->addXmlnukeObject(new BibliotecaDBXML($this->_context, "listarDireita"));

    $this->defaultXmlnukeDocument->addXmlnukeObject($blockMenu);
    $blockMenu->addXmlnukeObject(new BibliotecaDBXML($this->_context, "menu"));

    $this->defaultXmlnukeDocument->addXmlnukeObject($blockCenter);
    $blockCenter->addXmlnukeObject(new BibliotecaDBXML($this->_context, "processPageField"));
