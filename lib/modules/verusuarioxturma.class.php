...
class VerUsuarioXTurma extends PanteonEscolarBaseModule
{
    ...
    public function CreatePage()
    {
        ...
        $blockCenter->addXmlnukeObject(new VerUsuarioXTurmaDBXML($this->_context, "ver"));
