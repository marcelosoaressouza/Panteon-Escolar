...
class MinhasPropostasDeAcaoGrupo extends PanteonEscolarBaseModule
{

  public function CreatePage() {
    $myWords = $this->WordCollection();

    $titulo = "Proposta de Ação do Grupo";
    ...
    $blockHead->addXmlnukeObject(new MinhasPropostasDeAcaoGrupoDBXML($this->_context, "menuHead"));

    $this->defaultXmlnukeDocument->addXmlnukeObject($blockInfo);
    $blockInfo->addXmlnukeObject(new MinhasPropostasDeAcaoGrupoDBXML($this->_context, "listarDireita"));

    $this->defaultXmlnukeDocument->addXmlnukeObject($blockMenu);
    $blockMenu->addXmlnukeObject(new MinhasPropostasDeAcaoGrupoDBXML($this->_context, "menu"));

    $this->defaultXmlnukeDocument->addXmlnukeObject($blockCenter);
    $blockCenter->addXmlnukeObject(new MinhasPropostasDeAcaoGrupoDBXML($this->_context, "processPageField"));
