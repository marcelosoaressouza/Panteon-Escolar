...
class CriarGrupo extends PanteonEscolarBaseModule
{
  ...
  public function CreatePage()
  {
    ...
    $blockHead->addXmlnukeObject(new CriarGrupoDBXML($this->_context, "menuHead"));

    $this->defaultXmlnukeDocument->addXmlnukeObject($blockInfo);
    $blockInfo->addXmlnukeObject(new CriarGrupoDBXML($this->_context, "listarDireita"));

    $this->defaultXmlnukeDocument->addXmlnukeObject($blockMenu);
    $blockMenu->addXmlnukeObject(new CriarGrupoDBXML($this->_context, "menu"));

    $this->defaultXmlnukeDocument->addXmlnukeObject($blockCenter);
    $blockCenter->addXmlnukeObject(new CriarGrupoDBXML($this->_context, "processPageField"));
