...
class CriarPontoDeVistaTemaPanteon extends PanteonEscolarBaseModule
{

  public function CreatePage() {
    $myWords = $this->WordCollection();

    $titulo = "Criar Sujeito e Ponto de Vista";
    ...
    $blockHead->addXmlnukeObject(new CriarPontoDeVistaTemaPanteonDBXML($this->_context, "menuHead"));

    $this->defaultXmlnukeDocument->addXmlnukeObject($blockInfo);
    $blockInfo->addXmlnukeObject(new CriarPontoDeVistaTemaPanteonDBXML($this->_context, "listarDireita"));

    $this->defaultXmlnukeDocument->addXmlnukeObject($blockMenu);
    $blockMenu->addXmlnukeObject(new CriarPontoDeVistaTemaPanteonDBXML($this->_context, "menu"));

    $this->defaultXmlnukeDocument->addXmlnukeObject($blockCenter);
    $blockCenter->addXmlnukeObject(new CriarPontoDeVistaTemaPanteonDBXML($this->_context, "processPageField"));
