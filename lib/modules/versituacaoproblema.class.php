...
class VerSituacaoProblema extends PanteonEscolarBaseModule
{
  ...
  public function CreatePage()
  {
    ...
    $blockCenter->addXmlnukeObject(new VerSitucaoProblemaDBXML($this->_context, "ver"));
