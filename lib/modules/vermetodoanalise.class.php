...
class VerMetodoAnalise extends PanteonEscolarBaseModule
{
  ...
  public function CreatePage()
  {
    ...
    $blockCenter->addXmlnukeObject(new VerMetodoAnaliseDBXML($this->_context, "ver"));
