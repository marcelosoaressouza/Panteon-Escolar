...
class MinhasEstruturasSociais extends PanteonEscolarBaseModule
{

  public function CreatePage() {
    $myWords = $this->WordCollection();

    $titulo = "Minhas Estruturas Sociais";
    ...
    $blockHead->addXmlnukeObject(new MinhasEstruturasSociaisDBXML($this->_context, "menuHead"));

    $this->defaultXmlnukeDocument->addXmlnukeObject($blockInfo);
    $blockInfo->addXmlnukeObject(new MinhasEstruturasSociaisDBXML($this->_context, "listarDireita"));

    $this->defaultXmlnukeDocument->addXmlnukeObject($blockMenu);
    $blockMenu->addXmlnukeObject(new MinhasEstruturasSociaisDBXML($this->_context, "menu"));

    $this->defaultXmlnukeDocument->addXmlnukeObject($blockCenter);
    $blockCenter->addXmlnukeObject(new MinhasEstruturasSociaisDBXML($this->_context, "processPageField"));
