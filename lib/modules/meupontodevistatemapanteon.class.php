...
class MeuPontoDeVistaTemaPanteon extends PanteonEscolarBaseModule
{

  public function CreatePage() {
    $myWords = $this->WordCollection();

    $titulo = "Escolha o Ponto de Vista";
    ...
    $blockHead->addXmlnukeObject(new MeuPontoDeVistaTemaPanteonDBXML($this->_context, "menuHead"));

    $this->defaultXmlnukeDocument->addXmlnukeObject($blockInfo);
    $blockInfo->addXmlnukeObject(new MeuPontoDeVistaTemaPanteonDBXML($this->_context, "listarDireita"));

    $this->defaultXmlnukeDocument->addXmlnukeObject($blockMenu);
    $blockMenu->addXmlnukeObject(new MeuPontoDeVistaTemaPanteonDBXML($this->_context, "menu"));

    $this->defaultXmlnukeDocument->addXmlnukeObject($blockCenter);
    $blockCenter->addXmlnukeObject(new MeuPontoDeVistaTemaPanteonDBXML($this->_context, "processPageField"));
