...
class VerEstruturaSocialComSujeitos extends PanteonEscolarBaseModule
{
  ...
  public function CreatePage()
  {
    ...
    $blockCenter->addXmlnukeObject(new VerEstruturaSocialComSujeitosDBXML($this->_context, "ver"));
