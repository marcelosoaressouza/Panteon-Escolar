...
class MeuForum extends PanteonEscolarBaseModule
{
  ...
  public function CreatePage()
  {
    ...
    $blockHead->addXmlnukeObject(new MeuForumDBXML($this->_context, "menuHead"));

    $this->defaultXmlnukeDocument->addXmlnukeObject($blockInfo);
    $blockInfo->addXmlnukeObject(new MeuForumDBXML($this->_context, "listarDireita"));

    $this->defaultXmlnukeDocument->addXmlnukeObject($blockMenu);
    $blockMenu->addXmlnukeObject(new MeuForumDBXML($this->_context, "menu"));

    $this->defaultXmlnukeDocument->addXmlnukeObject($blockCenter);
    $blockCenter->addXmlnukeObject(new MeuForumDBXML($this->_context, "processPageField"));
