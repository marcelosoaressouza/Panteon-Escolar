...
class CriarPontoDeVistaSujeitoTemaPanteon extends PanteonEscolarBaseModule
{

  public function CreatePage() {
    $myWords = $this->WordCollection();

    $titulo = "Criar Ponto de Vista do Sujeito";
    ...
    $blockHead->addXmlnukeObject(new CriarPontoDeVistaSujeitoTemaPanteonDBXML($this->_context, "menuHead"));

    $this->defaultXmlnukeDocument->addXmlnukeObject($blockInfo);
    $blockInfo->addXmlnukeObject(new CriarPontoDeVistaSujeitoTemaPanteonDBXML($this->_context, "listarDireita"));

    $this->defaultXmlnukeDocument->addXmlnukeObject($blockMenu);
    $blockMenu->addXmlnukeObject(new CriarPontoDeVistaSujeitoTemaPanteonDBXML($this->_context, "menu"));

    $this->defaultXmlnukeDocument->addXmlnukeObject($blockCenter);
    $blockCenter->addXmlnukeObject(new CriarPontoDeVistaSujeitoTemaPanteonDBXML($this->_context, "processPageField"));
