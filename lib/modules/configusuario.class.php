...
class ConfigUsuario extends PanteonEscolarBaseModule
{
  ...
  public function CreatePage()
  {
    ...
    $titulo = "Usuário(s) da Instituição";
    ...
    $blockHead->addXmlnukeObject(new ConfigUsuarioDBXML($this->_context, "menuHead"));

    $this->defaultXmlnukeDocument->addXmlnukeObject($blockInfo);
    $blockInfo->addXmlnukeObject(new ConfigUsuarioDBXML($this->_context, "listarDireita"));

    $this->defaultXmlnukeDocument->addXmlnukeObject($blockMenu);
    $blockMenu->addXmlnukeObject(new ConfigUsuarioDBXML($this->_context, "menu"));

    $this->defaultXmlnukeDocument->addXmlnukeObject($blockCenter);
    $blockCenter->addXmlnukeObject(new ConfigUsuarioDBXML($this->_context, "processPageField"));
