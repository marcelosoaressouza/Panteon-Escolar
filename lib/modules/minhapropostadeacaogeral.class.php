...
class MinhaPropostaDeAcaoGeral extends PanteonEscolarBaseModule
{
  ...
  public function CreatePage()
  {
    ...
    $titulo = "Minhas Propostas de Ação Geral";
    ...
    $blockHead->addXmlnukeObject(new MinhaPropostaDeAcaoGeralDBXML($this->_context, "menuHead"));

    $this->defaultXmlnukeDocument->addXmlnukeObject($blockInfo);
    $blockInfo->addXmlnukeObject(new MinhaPropostaDeAcaoGeralDBXML($this->_context, "listarDireita"));

    $this->defaultXmlnukeDocument->addXmlnukeObject($blockMenu);
    $blockMenu->addXmlnukeObject(new MinhaPropostaDeAcaoGeralDBXML($this->_context, "menu"));

    $this->defaultXmlnukeDocument->addXmlnukeObject($blockCenter);
    $blockCenter->addXmlnukeObject(new MinhaPropostaDeAcaoGeralDBXML($this->_context, "processPageField"));
