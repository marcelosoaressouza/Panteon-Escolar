...
class CriarMural extends PanteonEscolarBaseModule
{
  ...
  public function CreatePage()
  {
    ...
    $titulo = "Enviar Mensagem ao Mural";
    ...
    $blockHead->addXmlnukeObject(new CriarMuralDBXML($this->_context, "menuHead"));

    $this->defaultXmlnukeDocument->addXmlnukeObject($blockInfo);
    $blockInfo->addXmlnukeObject(new CriarMuralDBXML($this->_context, "listarDireita"));

    $this->defaultXmlnukeDocument->addXmlnukeObject($blockMenu);
    $blockMenu->addXmlnukeObject(new CriarMuralDBXML($this->_context, "menu"));

    $this->defaultXmlnukeDocument->addXmlnukeObject($blockCenter);
    $blockCenter->addXmlnukeObject(new CriarMuralDBXML($this->_context, "processPageField"));
