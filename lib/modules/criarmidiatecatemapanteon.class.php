...
class CriarMidiatecaTemaPanteon extends PanteonEscolarBaseModule
{
  ...
  public function CreatePage()
  {
    ...
    $titulo = "Minha Midiateca Tema Panteon";
    ...
    $blockHead->addXmlnukeObject(new CriarMidiatecaTemaPanteonDBXML($this->_context, "menuHead"));

    $this->defaultXmlnukeDocument->addXmlnukeObject($blockInfo);
    $blockInfo->addXmlnukeObject(new CriarMidiatecaTemaPanteonDBXML($this->_context, "listarDireita"));

    $this->defaultXmlnukeDocument->addXmlnukeObject($blockMenu);
    $blockMenu->addXmlnukeObject(new CriarMidiatecaTemaPanteonDBXML($this->_context, "menu"));

    $this->defaultXmlnukeDocument->addXmlnukeObject($blockCenter);
    $blockCenter->addXmlnukeObject(new CriarMidiatecaTemaPanteonDBXML($this->_context, "processPageField"));
