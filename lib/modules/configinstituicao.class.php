...
class ConfigInstituicao extends PanteonEscolarBaseModule
{
  ...
  public function CreatePage()
  {
    ...
    $blockHead->addXmlnukeObject(new ConfigInstituicaoDBXML($this->_context, "menuHead"));

    $this->defaultXmlnukeDocument->addXmlnukeObject($blockInfo);
    $blockInfo->addXmlnukeObject(new ConfigInstituicaoDBXML($this->_context, "listarDireita"));

    $this->defaultXmlnukeDocument->addXmlnukeObject($blockMenu);
    $blockMenu->addXmlnukeObject(new ConfigInstituicaoDBXML($this->_context, "menu"));

    $this->defaultXmlnukeDocument->addXmlnukeObject($blockCenter);
    $blockCenter->addXmlnukeObject(new ConfigInstituicaoDBXML($this->_context, "processPageField"));
