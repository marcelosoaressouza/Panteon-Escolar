...
class CriarSituacaoProblemaTemaPanteon extends PanteonEscolarBaseModule
{
  ...
  public function CreatePage()
  {
    ...
    $titulo = "Criar Situações-Problemas";
    ...
    $blockHead->addXmlnukeObject(new CriarSituacaoProblemaTemaPanteonDBXML($this->_context, "menuHead"));

    $this->defaultXmlnukeDocument->addXmlnukeObject($blockInfo);
    $blockInfo->addXmlnukeObject(new CriarSituacaoProblemaTemaPanteonDBXML($this->_context, "listarDireita"));

    $this->defaultXmlnukeDocument->addXmlnukeObject($blockMenu);
    $blockMenu->addXmlnukeObject(new CriarSituacaoProblemaTemaPanteonDBXML($this->_context, "menu"));

    $this->defaultXmlnukeDocument->addXmlnukeObject($blockCenter);
    $blockCenter->addXmlnukeObject(new CriarSituacaoProblemaTemaPanteonDBXML($this->_context, "processPageField"));
