...
class MeusMetodosDeAnalise extends PanteonEscolarBaseModule
{
  ...
  public function CreatePage()
  {
    ...
    $titulo = "Meus Métodos de Análise";
    ...
    $blockHead->addXmlnukeObject(new MeusMetodosDeAnaliseDBXML($this->_context, "menuHead"));

    $this->defaultXmlnukeDocument->addXmlnukeObject($blockInfo);
    $blockInfo->addXmlnukeObject(new MeusMetodosDeAnaliseDBXML($this->_context, "listarDireita"));

    $this->defaultXmlnukeDocument->addXmlnukeObject($blockMenu);
    $blockMenu->addXmlnukeObject(new MeusMetodosDeAnaliseDBXML($this->_context, "menu"));

    $this->defaultXmlnukeDocument->addXmlnukeObject($blockCenter);
    $blockCenter->addXmlnukeObject(new MeusMetodosDeAnaliseDBXML($this->_context, "processPageField"));
