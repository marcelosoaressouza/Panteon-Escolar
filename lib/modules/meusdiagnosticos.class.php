...
class MeusDiagnosticos extends PanteonEscolarBaseModule
{
  ...
  public function CreatePage()
  {
    ...
    $blockHead->addXmlnukeObject(new MeusDiagnosticosDBXML($this->_context, "menuHead"));

    $this->defaultXmlnukeDocument->addXmlnukeObject($blockInfo);
    $blockInfo->addXmlnukeObject(new MeusDiagnosticosDBXML($this->_context, "listarDireita"));

    $this->defaultXmlnukeDocument->addXmlnukeObject($blockMenu);
    $blockMenu->addXmlnukeObject(new MeusDiagnosticosDBXML($this->_context, "menu"));

    $this->defaultXmlnukeDocument->addXmlnukeObject($blockCenter);
    $blockCenter->addXmlnukeObject(new MeusDiagnosticosDBXML($this->_context, "processPageField"));
